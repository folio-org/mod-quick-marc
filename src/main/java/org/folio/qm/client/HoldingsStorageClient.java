...
public interface HoldingsStorageClient {
  ...
  ResponseEntity<Void> updateHolding(@PathVariable("id") String id, HoldingsRecord holdingsRecord);

  @PostMapping(value = "/holdings", produces = APPLICATION_JSON_VALUE)
  ResponseEntity<HoldingsRecord> createHolding(HoldingsRecord holdingsRecord);
}
