...
import static org.folio.qm.client.model.instance.Dates.convertToDates;
import static org.folio.qm.client.model.instance.Dates.datesToJson;
import static org.folio.qm.client.model.instance.Dates.retrieveDatesFromJson;
import static org.folio.qm.service.support.JsonArrayHelper.toListOfStrings;
...
import org.folio.qm.client.model.Metadata;
import org.folio.qm.service.support.JsonArrayHelper;
import org.folio.qm.service.support.JsonHelper;
...
public class Instance {
  ...
  public JsonObject getJsonForStorage() {
    ...
    json.put(TAGS_KEY, new JsonObject()
      .put(TAG_LIST_KEY, new JsonArray(getTags() == null ? Collections.emptyList() : getTags())));
  ...
  public JsonObject getJsonForResponse(WebContext context) {
    ...
    if (succeedingTitles != null) {
      ...
      succeedingTitles.forEach(succeedingTitle ->
        succeedingTitlesJsonArray.add(succeedingTitle.toSucceedingTitleJson()));
