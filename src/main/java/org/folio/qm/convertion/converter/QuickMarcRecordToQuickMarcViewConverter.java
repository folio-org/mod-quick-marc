...
public class QuickMarcRecordToQuickMarcViewConverter implements Converter<QuickMarcRecord, QuickMarcView> {

  private final MarcFieldsConverter fieldsConverter;

  @Override
  public QuickMarcView convert(QuickMarcRecord source) {
