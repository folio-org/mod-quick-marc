...
public enum PhysicalDescriptionsTestEntities {
  ELECTRONIC_RESOURCE_MISSING_ITEMS, ELECTRONIC_RESOURCE, GLOBE, KIT, MAP, MICROFORM, MOTION_PICTURE, NONPROJECTED_GRAPHIC,
  NOTATED_MUSIC, PROJECTED_GRAPHIC, REMOTE_SENSING_IMAGE, SOUND_RECORDING, TACTILE_MATERIAL, TEXT, UNSPECIFIED, VIDEORECORDING,
  UNKNOWN;
