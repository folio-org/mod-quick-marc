...
//
//@UnitTest
//class InstanceRecordMapperTest {
//
...
//
//  private final InstanceRecordMapper mapper = Mappers.getMapper(InstanceRecordMapper.class);
//
//  @Test
...
//  }
//
//  private org.folio.Instance createFolioInstance(String id, String title, String hrid, List<String> notes) {
//    org.folio.Instance instance = new org.folio.Instance();
//    instance.setId(id);
