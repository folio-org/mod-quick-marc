...
public enum GeneralTestEntities {
  ...
  GeneralTestEntities(MaterialTypeConfiguration materialTypeConfiguration, String parsedRecordPath, String quickMarcJsonPath,
                      List<Leader> leaders) {
