...
public class DataBaseTestUtils {
  ...
  public static void saveCreationStatus(String id, String jobExecutionId, FolioModuleMetadata metadata,
                                        JdbcTemplate jdbcTemplate) {
    var sql =
      "INSERT INTO " + creationStatusTable(ApiTestUtils.TENANT_ID, metadata) + " (id, job_execution_id) VALUES (?, ?)";
    jdbcTemplate.update(sql, UUID.fromString(id), UUID.fromString(jobExecutionId));
  }
